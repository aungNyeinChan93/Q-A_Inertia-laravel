            ...
            <div class="mx-auto max-w-lg">
                ...
                <form @submit.prevent="formSubmit" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="file" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                                :class="{ 'border border-red-600': $page.props.errors.image }" placeholder="Avator"
                                @input="change" />
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="name" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                                :class="{ 'border border-red-600': $page.props.errors.name }" v-model="form.name"
                        ...
                        <div class="text-red-600 text-sm px-2 py-1 ">{{ $page.props.errors.name }}</div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="email" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                                :class="{ 'border border-red-600': $page.props.errors.email }" v-model="form.email"
                        ...
                        <div class="text-red-600 text-sm px-2 py-1 ">{{ $page.props.errors.email }}</div>
                    ...
                    <div>
                        ...
                        <div class="text-red-600 text-sm px-2 py-1 ">{{ $page.props.errors.password }}</div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                                :class="{ 'border border-red-600': $page.props.errors.password_confirmation }"
                                v-model="form.password_confirmation" placeholder="Enter password_confirmation" />
                        ...
                        <div class="text-red-600 text-sm px-2 py-1 ">{{ $page.props.errors.password_confirmation }}
                        </div>

                    </div>

                    <button type="submit" :disabled="form.processing" :class="{'bg-blue-500/50':form.processing}"
                        class="flex justify-around items-center w-[150px] rounded-lg bg-indigo-600 px-5 py-3 text-sm font-medium text-white ">
                        <span v-if="!form.processing"> Register</span>
                        <span v-else> Loading ... </span>
                        <div role="status" v-if="form.processing">
                            <svg aria-hidden="true"
                                class="w-4 h-4 text-gray-200 animate-spin dark:text-green-600 fill-red-600"
