                    ...
                    <form @submit.prevent="profileUpdate">
                        ...
                        <div class="mb-6">
                            ...
                            <input @input="change"
                                ...
                                <div class="text-sm text-red-600 p-1 mt-1">{{ errors.image }}</div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="default-input" v-model="form.name"
                                ...
                                <div class="text-sm text-red-600  mt-1">{{ errors.name }}</div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="default-input" v-model="form.email"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
                                 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600
                                  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <div class="text-sm text-red-600  mt-1">{{ errors.email }}</div>

                        </div>

                        <div class="mb-6">
                            <button type="submit"
                                :class="{'text-red-800':form.processing}" :disabled="form.processing"
                                ...
                                focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2
                                 dark:bg-gray-600 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Back</Link>
                        </div>
